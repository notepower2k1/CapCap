...
def build_preview_panel(gui):
    ...
    gui.quick_preview_btn = QPushButton("Quick Preview")
    gui.styled_preview_btn = QPushButton("Styled Preview")
    ...
    controls_layout.addWidget(gui.quick_preview_btn)
    controls_layout.addWidget(gui.styled_preview_btn)
