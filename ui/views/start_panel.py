...
def build_start_group(gui, left_layout):
    ...
    gui.use_clone_voice_radio = QRadioButton("Use clone voice")
    ...
    gui.voice_tier_group.addButton(gui.use_clone_voice_radio)
    gui.free_voice_combo = QComboBox()
    gui.premium_voice_combo = QComboBox()
    gui.clone_voice_combo = QComboBox()
    gui.create_clone_voice_btn = QPushButton("Create clone voice")
    gui.create_clone_voice_btn.clicked.connect(gui.open_clone_voice_dialog)
    gui.clone_voice_hint_label = QLabel("Clone voices are less stable. Use a clean 10-40s Vietnamese sample.")
    gui.clone_voice_hint_label.setObjectName("helperLabel")
    gui.clone_voice_hint_label.setWordWrap(True)
    ...
    voice_layout.addWidget(gui.use_clone_voice_radio)
    voice_layout.addWidget(gui.clone_voice_combo)
    voice_layout.addWidget(gui.create_clone_voice_btn)
    voice_layout.addWidget(gui.clone_voice_hint_label)
