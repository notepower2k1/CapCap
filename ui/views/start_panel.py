...
def build_start_group(gui, left_layout):
    ...
    gui.preview_voice_btn = QPushButton("Voice library")
    gui.preview_voice_btn.clicked.connect(gui.preview_selected_voice_sample)
    gui.voice_preview_meta_label = QLabel("Open a separate popup to preview the configured sample clip for each voice.")
    ...
    custom_controls_layout.addWidget(QLabel("Position Mode:"), 3, 0)
    custom_controls_layout.addWidget(gui.subtitle_position_mode_combo, 3, 1)
    custom_controls_layout.addWidget(gui.subtitle_align_label, 4, 0)
    custom_controls_layout.addWidget(gui.subtitle_align_combo, 4, 1)
    custom_controls_layout.addWidget(gui.subtitle_custom_x_label, 5, 0)
    custom_controls_layout.addWidget(gui.subtitle_custom_x_spin, 5, 1)
    custom_controls_layout.addWidget(gui.subtitle_custom_y_label, 6, 0)
    custom_controls_layout.addWidget(gui.subtitle_custom_y_spin, 6, 1)
    custom_controls_layout.addWidget(QLabel("Animation:"), 7, 0)
    custom_controls_layout.addWidget(gui.subtitle_animation_combo, 7, 1)
    custom_controls_layout.addWidget(gui.subtitle_animation_time_label, 8, 0)
    custom_controls_layout.addWidget(gui.subtitle_animation_time_spin, 8, 1)
    custom_controls_layout.addWidget(gui.subtitle_karaoke_timing_label, 9, 0)
